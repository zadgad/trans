@extends('layouts.appl', ['activePage' => 'user-management', 'titlePage' => __(' Lista de Departamento ')])
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>Informacion de los Departamentos registrados en sistema</span>
                            <br>
                            <br>
                            <h6> </h6>
                        </div>
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Lista Departamentos</li>
                        </ol>
                    </nav>
                </div>
            </div>
